...
from plot import plot_training_validation, compare_best_models
...
plot_training_validation(train_stochastic_err, train_stochastic_acc, val_stochastic_err, val_stochastic_acc)
...
print(f"Final training error: {train_batch_err[-1]:.4f}, training accuracy: {train_batch_acc[-1]:.4f}")
print(f"Final validation error: {val_batch_err[-1]:.4f}, validation accuracy: {val_batch_acc[-1]:.4f}")
print(f"Final testing error: {test_batch_err:.4f}, testing accuracy: {test_batch_acc:.4f}")
plot_training_validation(train_batch_err, train_batch_acc, val_batch_err, val_batch_acc)

compare_best_models(val_stochastic_err, val_stochastic_acc, val_batch_err, val_batch_acc)
